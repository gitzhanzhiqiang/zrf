<template>
    <div class="app-container calendar-list-container ggg_user">
        ...
        <el-button type="primary" @click="$router.push('clientMessageDetail')" v-show="false">新增</el-button>
        <div class="filter-container">
            ...
            <el-table :data="dataList" v-loading="listLoading" border fit highlight-current-row style="width: 100%">
                ...
                <el-table-column align="center" label="借款人" width="70">  
                    <template scope="scope">
                ...
                <el-table-column align="center" label="希望借款金额" width="110">
                    <template scope="scope">
                        {{scope.row.applyAmount | formatMoney}}
                    </template>
                </el-table-column>
                <el-table-column align="center" label="合同放款金额" width="110">
                    <template scope="scope">
                ...
                <el-table-column align="center" label="操作" fixed="right" width="100">
                    <template scope="scope">
                        <el-button type="text" size="small" @click="$router.push({path:'clientMessageDetail', query:{data: JSON.stringify(scope.row)}})">查看</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
