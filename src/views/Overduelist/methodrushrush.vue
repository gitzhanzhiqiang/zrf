            ...
            <el-table :data="dataList" v-loading="listLoading" border fit highlight-current-row style="width: 100%">
                ...
                <el-table-column align="center" label="借款人" width="">
                 ...
                 <el-table-column align="center" label="逾期状态" width="">
                    <template scope="scope">
                          <span v-show ='scope.row.yqzt ==2'>门店法催</span>
                ...
                <el-table-column align="center" label="法催" width="200">
                    <template scope="scope">
                        {{scope.row.fcname}}
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        download() {
            downloadExecl({ url: 'export/exportOverBackListFc', input: this.params, method: 'get' })
        },
        getTable(isseach) {
            ...
            ajax({
                url: 'overDue/FcColBackOrderList',
