    ...
    <div class="app-container calendar-list-container ggg_user">
        ...
        <div class="filter-container">
            ...
            <el-table :data="dataList" v-loading="listLoading" border fit highlight-current-row style="width: 100%">
                ...
                <el-table-column align="center" label="逾期状态" width="90">
                </el-table-column>
                ...
                <el-table-column align="center" label="当期状态" width="100">
                    <template scope="scope" v-if="{{scope.row.repaymentStatus==11 }}">
                        逾期中
                    </template>
                </el-table-column>
                ...
                <el-table-column align="center" label="操作" fixed="right" width="80">
                    <template scope="scope">
                        <el-button type="text" size="small" @click="$router.push({path:'overduelists_kan', query:{data: JSON.stringify(scope.row), addresslist: true}})">查看</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
...
import { parseTime, formatMoney, formatTime } from '@src/filters';
