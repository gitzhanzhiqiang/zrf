    ...
    <div class="app-container calendar-list-container ggg_user">
        ...
        <el-form :inline="true" :model="params" ref="params" class="demo-form-inline" @keyup.enter.native="getTable('isseach')">
            ...
            <el-form-item label="业务员" prop="adminid">
             ...
             <el-form-item label="逾期状态" prop="yqzt">
                <el-select v-model="params.yqzt" placeholder="请选择逾期状态">
                    <el-option v-for="item in storage.collectResultsa" :key="item.id" :label="item.label" :value="item.id + ''">
                    </el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
            ...
            <el-table :data="dataList" v-loading="listLoading" border fit highlight-current-row style="width: 100%">
                ...
                <el-table-column align="center" label="借款人" width="">
                 ...
                 <el-table-column align="center" label="逾期状态" width="">
                    <template scope="scope">
                        <span v-show ='scope.row.yqzt ==1'>门店催收</span>
                        <span v-show ='scope.row.yqzt ==2'>总部电催</span>
                          <span v-show ='scope.row.yqzt ==3'>门店法催</span>
                ...
                <el-table-column align="center" label="门店法催" width="">
                    <template scope="scope">
                        {{scope.row.fcname}}
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        download() {
            downloadExecl({ url: 'export/exportOverBackList', input: this.params, method: 'get' })
        },
        getTable(isseach) {
