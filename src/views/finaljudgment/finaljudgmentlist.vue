<template>
    <div class="app-container calendar-list-container ggg_user">
        ...
        <el-form :inline="true" :model="params" ref="params" class="demo-form-inline" @keyup.enter.native="getTable('isseach')">
            ...
            <el-form-item label="申请额度" prop="agreementAmount">
                <el-input type="number" v-model="params.agreementAmount" placeholder="请输入申请额度"></el-input>
            </el-form-item>
        ...
        <div class="filter-container">
            <!--<div class="tableheader">终审系统</div>-->
            <el-table :data="dataList" v-loading="listLoading" border fit highlight-current-row style="width: 100%">
                ...
                <el-table-column align="center" label="操作" fixed="right" width="70">
                    <template scope="scope">
                        <el-button type="text" size="small" @click="$router.push({path:'finaljudgmentlistDetail', query:{data: JSON.stringify(scope.row)}})">查看</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
...
export default {
    data() {
        return {
            ...
            params: { //搜索条件
                type: 3, //必传 type 查询类型 1：行政查询 2：初审查询 *3：终审查询* 4：待合同上传界面查询* 5:财务待放款查询* 6：财务拒绝查询
                pageSize: 10,
                pageIndex: 1,
                userName: null, //用户名字
                orderNum: null, //订单编号
                prodID: null, //产品id
                agreementAmount: null, //申请额度
                source: null, //订单来源
