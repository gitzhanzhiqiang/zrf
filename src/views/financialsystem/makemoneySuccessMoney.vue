<template>
    <div class="app-container calendar-list-container">
        ...
        <el-form :inline="true" :model="params" ref="params" class="demo-form-inline" @keyup.enter.native="getApplyList(true)">
            ...
            <el-form-item label="订单来源" prop="source">
                <el-select v-model="params.source" placeholder="请选择订单来源">
                    <el-option v-for="item in storage.source" :key="item.value" :label="item.label" :value="item.id"></el-option>
                </el-select>
            </el-form-item>
            ...
            <div v-show="false">
                ...
                <el-form-item label="结束时间" prop="dateFrom">
                    <el-input v-model="params.dateFrom" placeholder="结束"></el-input>
                </el-form-item>
            </div>
            <el-form-item>
        ...
        <div class="filter-container">
            <!--<div class="tableheader">已放款订单</div>-->
                ...
                <div class="tablelayer">
                    <el-table :data="dataList" v-loading="listLoading" border fit highlight-current-row style="width: 100%">
                        ...
                        <el-table-column align="center" label="操作" fixed="right" width="70">
                            <template scope="scope">
                                <el-button type="text" size="small" @click="$router.push({path:'makemoneysuccessmoneydetail', query:{data: JSON.stringify(scope.row)}})">查看</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
...
export default {
    ...
    methods: {
        ...
        getApplyList(isSeach) {
            ...
            ajax({
                url: 'financeLoan/listLoanSuccess',
