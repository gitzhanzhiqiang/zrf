    ...
    <div class="app-container calendar-list-container">
        ...
        <el-form :inline="true" :model="params" ref="params" class="demo-form-inline" @keyup.enter.native="getApplyList(true)">
            ...
            <el-form-item label="借款人" prop="name">
                <el-input type="text" v-model="params.name" placeholder="请输入姓名"></el-input>
            </el-form-item>
        ...
        <div class="filter-container">
            <!--<div class="tableheader">财务拒绝订单</div>-->
            <div class="tablelayer">
                ...
                <div class="tablelayer">
                    <el-table :data="dataList" v-loading="listLoading" border fit highlight-current-row style="width: 100%">
                        ...
                        <el-table-column align="center" label="拒绝时间" width="160">
                            <template scope="scope">
                                <span>{{scope.row.rejectTime | parseTime('{y}-{m}-{d} {h}:{i}:{s}')}}</span>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column align="center" label="借款期数" width="120">
                            <template scope="scope">
                                {{scope.row.loanTerm}}
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column align="center" label="订单来源" width="100">
                            <template scope="scope">
                        ...
                        <el-table-column align="center" label="操作" fixed="right" width="70">
                            <template scope="scope">
                                <el-button type="text" size="small" @click="$router.push({path:'makemoneyRefuseMoneyDetail', query:{data: JSON.stringify(scope.row)}})">查看</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
