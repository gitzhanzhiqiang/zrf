            ...
            <el-tab-pane label="核心数据">
                <el-form :rules="rules" ref="alertFrom" label-position="center" label-width="0px" :model="form" class="table_css kernel">
                    ...
                    <div class="filter-container">
                        ...
                        <table style="" class="table noborder" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>申请产品</td>
                                <td>
                                    <el-form-item>
                    ...
                    <!--建议-->
                    <div class="filter-container" v-show=" AuditData.spStatus == 8">
                        <table style="" class="table">
                            <tr>
                                <td>财务意见</td>
                                <td>
                                    <p style="width:200px;display:inline-block;">
                                        <el-form-item>
                                            <el-select v-model="AuditForm.status" placeholder="请选择">
                                                <el-option label="财务通过" value="1"></el-option>
                                                <el-option label="财务拒绝" value="2"></el-option>
                                                <el-option label="驳回合同" value="3"></el-option>
                                            </el-select>
                                        </el-form-item>
                                    </p>
                                    <p style="width:200px;display:inline-block;">
    ...
    methods: {
        ...
        getAudit() {
            ajax({
                ...
                optionParams: {
                    // orderNum: 'lalaah201803231725152964',
                    orderNum: this.rowData.orderNum,
                    orderUserId: this.rowData.orderUserId
                }
            }).post()
        ...
        submitAudit() {
            ...
            ajax({
                url: '/underlineProcess/financeApproval',
                optionParams: {
                    dto: this.form,
